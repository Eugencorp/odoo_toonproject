...
* [x] **Общий механизм загрузки preview и исходников** (включая разграничение прав на эту операцию) - ветка [file_fields](../../tree/file_fields). Общий механизм загрузки preview -- объединен с мастером.
#### Коннекторы:
